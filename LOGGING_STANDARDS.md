...
| `query`       | Yes      | `string`               | `"x=1&y=1"`                  | The unparsed query string from the URL
...
| `started_at`  | No       | `datetime`<sup>1</sup> | `"2019-01-21T16:19:12.356Z"` | ISO8601 date string of the request start time
