...
7. Add [environment keys](https://github.com/ONSdigital/dp-ci/tree/master/gpg-keys#adding-a-gpg-key-to-your-keyring) to keychain. You'll need to ask one of the *developers* for the `develop` passphrase or ask your *Tech Lead* for the `production` passphrase first.
