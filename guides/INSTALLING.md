...
| [nvm](https://github.com/nvm-sh/nvm)                               | Follow the [git install instructions](https://github.com/nvm-sh/nvm?tab=readme-ov-file#git-install) |                                                                                                                              |
| [Go](https://go.dev/dl/)                                           | `$ brew install go`                                                                                 | The Go installation is processor architecture specific.[^1]                                                                  |
...
[^1]: For the newer Apple M1 processor the ARM installation is required. This is managed by Homebrew. However, if installing manually this is something to be aware of. [Go direct Download](https://go.dev/dl/)

[dp-compose](https://github.com/ONSdigital/dp-compose/tree/main/v2/stacks/v1-compat) runs the following services:
...
Run [dp-compose v1-compat stack](https://github.com/ONSdigital/dp-compose/blob/main/v2/stacks/v1-compat) using the `$ make up` command (in the dp-compose repo) to run the supporting services.
...
> You will want to make sure you have access to the Neptune test instance as well, if you want the entire CMD journey to be accessible. Details on how to set this up can be found in [our Neptune guide](https://github.com/ONSdigital/dp/blob/main/guides/NEPTUNE.md).
