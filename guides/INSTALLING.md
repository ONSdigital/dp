...
-------- | ------- | ----- |
[Java 8 JDK (OpenJDK)](https://openjdk.java.net/install/) | `$ brew install openjdk@8 ` | Append `export PATH="/usr/local/opt/openjdk@8/bin:$PATH"` and `export JAVA_HOME="/Library/Java/JavaVirtualMachines/openjdk-8.jdk/Contents/Home/"` to your shell profile (eg. `.zshrc`) and restart your terminal.
