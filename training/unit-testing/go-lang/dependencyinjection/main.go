...
import (
	...
	"github.com/ONSdigital/dp/training/unit-testing/go-lang/dependencyinjection/service"
	"os"
	"strconv"
)
// main is a simple implementation of a database routine which takes in a value from the
// user and gets the result from the database.
func main() {
	...
	serv := &service.Service{Store: store}
